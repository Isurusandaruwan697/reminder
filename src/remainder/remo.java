...
public class remo extends javax.swing.JFrame {
   ...
   public void currentdt(){
    ...
    LocalTime myObj = LocalTime.now();
     DateTimeFormatter myobj2 = DateTimeFormatter.ofPattern("HH:mm:ss");
    String formattedtime = myObj.format(myobj2);
    jLabel6.setText(formattedtime);
    
    
     LocalDate dateobj = LocalDate.now();
     DateTimeFormatter myobj3=DateTimeFormatter.ofPattern("dd-MM-yyyy");
     String formateddate=dateobj.format(myobj3);
     jLabel5.setText(formateddate);
   ...
   public void set(){
       ...
       time=jTextField3.getText();
       description=jTextField4.getText();
       
        try {
            
            String sql="INSERT INTO tab (date,time,des)VALUES ('"+date+"','"+time+"','"+description+"')";
   ...
   public void clear(){
    ...
    private void initComponents() {
        ...
        jButton2.setText("Check For the day");
